<?php include("../Controlador/Cancion.php"); ?> 
  ...
  <header>
    ...
    <div class="contenedor">
      ...
      <nav class = "menu">
        ...
        <a href="../Vista/productores.php">Disqueras</a>
...
<html lang="es">
  ...
  <footer>
      ...
      <!-- <div class="contenedor">
          <p class="copy">Flives Records &copy; 2022</p>
          <div class="sociales">
